...
func (w *ServerInterfaceWrapper) AllocateAll(ctx echo.Context) error {
	var err error

	var requestBody AllocateAllRequestBody
...
// AddPet converts echo context to params.
func (w *ServerInterfaceWrapper) AutoAllocate(ctx echo.Context) error {
	var err error

	var requestBody AutoAllocateRequestBody
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/allocate-all", wrapper.AllocateAll)
	router.POST(baseURL+"/auto-allocate", wrapper.AutoAllocate)
